        ...
        <xsl:if test="FpTrdTrdHdrPtyTrdIdfTrdID">
         ...
         <xsl:if test="FpTrdTrdHdrPtyTrdIdfIssuer">
          ...
          <xsl:variable name="value2">
            ...
            <partyReference>
               <xsl:if test="FpTrdTrdHdrPtyTrdIdfPtyhref">
                  <xsl:attribute name="href">
                    <xsl:value-of select="$value2" />
                  </xsl:attribute>
              </xsl:if>
...
<!-- ########### -->
		<xsl:if test="FpTrdTrdHdrPtyTrdIdfOrgTrdID">
			<xsl:variable name="value3">
				<xsl:value-of select="FpTrdTrdHdrPtyTrdIdfOrgTrdID"/>
            ...
            <originatingTradeId>
                  ...
                  <tradeId>
                        <xsl:attribute name="tradeIdScheme">
                          <xsl:value-of select="FpTrdTrdHdrPtyTrdIdfOrgTrdIDSch" />
                        </xsl:attribute>
                  ...
                  <partyReference>
                        <xsl:attribute name="href">
                          <xsl:value-of select="FpTrdTrdHdrPtyTrdIdfOrgPtyhref" />
                        </xsl:attribute>
                  </partyReference>
            </originatingTradeId>
		</xsl:if>
...
<xsl:template name="temp32_13" match="FpFraDiscounting">
  ...
  <xsl:template name="temp33" match="ExecutionNotification"><!-- root template -->
  <executionNotification fpmlVersion="5-6" >
