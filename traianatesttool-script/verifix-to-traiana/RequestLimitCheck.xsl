...
<xsl:template name="temp6" match="FpCreAppModel">
 ...
 <xsl:template name="temp7">
  
  <trade>
  <xsl:if test ="FpTrdTrdHdrPtyTrdIdfPtyhref|FpTrdTrdHdrPtyTrdIdfTrdID|FpPtyTrdInfoPtyRefhref|FpTrdDate">
   
   <tradeHeader>

       
      <xsl:if test="FpTrdTrdHdrPtyTrdIdfTrdID|FpTrdTrdHdrPtyTrdIdfPtyhref">
...
<!-- ########### -->
      ...
      <xsl:if test = "FpFraPayPtyhref|FpFraRcvPtyhref|FpFraAdjEffDate|FpFraAdjEffDtID|FpFraAdjTrmDate|FpFraUnAdjDate|FpFraPayDayBusDayConv|FpFraNoOfBusCntr|FpFraFxDatePrdMult|FpFraFxDatePrd|FpFratDtFxDateDayType|FpFraFxDateBusDayConv|FpFraNoOfFxDateBusCntr|FpFraFxDateRltTohref|FpFraDayCountFraction|FpFraCalcPrdNoOfDays|FpFraNotCurrency|FpFraNotAmount|FpFraFxdRate|FpFraFltRateIndex|FpFraIdxTenrPrdMult|FpFraIdxTenrPrd|FpFraDiscounting"> 
         <xsl:call-template name="temp_change_1"/>
      </xsl:if>
      <!-- End fra -->
      ...
      <xsl:if test = "FpTrdAllcTradeID|FpTrdAllcRefhref|FpTrdAllcCurrency|FpTrdAllcAmount|FpTrdAllcAppType|FpTrdAllcAppStatus"> 
...
<xsl:template name="temp31_6_1" match="FpFxlNonDevStlCurrency">
 ...
 <xsl:template name="temp31_6_2" match="FpFxlNonDevCurrency1|FpFxlNonDevCurrency2|FpFxlNonDevQotBasis|FpFxlNonDevFxDate">
<xsl:if test = "FpFxlNonDevCurrency1|FpFxlNonDevCurrency2|FpFxlNonDevQotBasis|FpFxlNonDevFxDate"> 
  <fixing>
	  <quotedCurrencyPair>
...
<xsl:template name="temp32" match="FpTrdAllcTradeID|FpTrdAllcRefhref|FpTrdAllcCurrency|FpTrdAllcAmount|FpTrdAllcAppType|FpTrdAllcAppStatus">
<xsl:if test = "FpTrdAllcTradeID|FpTrdAllcRefhref|FpTrdAllcCurrency|FpTrdAllcAmount|FpTrdAllcAppType|FpTrdAllcAppStatus"> 
...
<xsl:template name="temp32_1" match="FpTrdAllcTradeID">
  <xsl:if test = "FpTrdAllcTradeID"> 
  <allocationTradeId><tradeId>

                <xsl:value-of select="FpTrdAllcTradeID" />
   
  </tradeId></allocationTradeId>
</xsl:if>
</xsl:template>

<xsl:template name="temp32_2" match="FpTrdAllcRefhref">
  <accountReference>

            <xsl:attribute name="href">
                <xsl:value-of select="FpTrdAllcRefhref" />
            </xsl:attribute>
...
<xsl:template name="temp32_3" match="FpTrdAllcCurrency|FpTrdAllcAmount">
<xsl:if test = "FpTrdAllcCurrency|FpTrdAllcAmount"> 
  <allocatedNotional>
    <xsl:call-template name="temp32_3_1"/>
    <xsl:call-template name="temp32_3_2"/>
  </allocatedNotional>
</xsl:if>
</xsl:template>

<xsl:template name="temp32_3_1" match="FpTrdAllcCurrency">
  <xsl:if test = "FpTrdAllcCurrency"> 
  <currency>

                <xsl:value-of select="FpTrdAllcCurrency" />

  </currency>
</xsl:if>
</xsl:template>

<xsl:template name="temp32_3_2" match="FpTrdAllcAmount">
  <xsl:if test = "FpTrdAllcAmount"> 
  <amount>

                <xsl:value-of select="FpTrdAllcAmount" />
...
<xsl:template name="temp32_4" match="FpTrdAllcAppType|FpTrdAllcAppStatus">
<xsl:if test = "FpTrdAllcAppType|FpTrdAllcAppStatus"> 
  <approvals><approval>
    <xsl:call-template name="temp32_4_1"/>
    <xsl:call-template name="temp32_4_2"/>
  </approval></approvals>
</xsl:if>
</xsl:template>

<xsl:template name="temp32_4_1" match="FpTrdAllcAppType">
  <xsl:if test = "FpTrdAllcAppType"> 
  <type>

                <xsl:value-of select="FpTrdAllcAppType" />

  </type>
</xsl:if>
</xsl:template>

<xsl:template name="temp32_4_2" match="FpTrdAllcAppStatus">
  <xsl:if test = "FpTrdAllcAppStatus"> 
  <status>

                <xsl:value-of select="FpTrdAllcAppStatus" />
...
<xsl:template name="temp_change_1" match="FpFraPayPtyhref|FpFraRcvPtyhref|FpFraAdjEffDate|FpFraAdjEffDtID|FpFraAdjTrmDate|FpFraUnAdjDate|FpFraPayDayBusDayConv|FpFraNoOfBusCntr|FpFraFxDatePrdMult|FpFraFxDatePrd|FpFratDtFxDateDayType|FpFraFxDateBusDayConv|FpFraNoOfFxDateBusCntr|FpFraFxDateRltTohref|FpFraDayCountFraction|FpFraCalcPrdNoOfDays|FpFraNotCurrency|FpFraNotAmount|FpFraFxdRate|FpFraFltRateIndex|FpFraIdxTenrPrdMult|FpFraIdxTenrPrd|FpFraDiscounting">
<xsl:if test = "FpFraPayPtyhref|FpFraRcvPtyhref|FpFraAdjEffDate|FpFraAdjEffDtID|FpFraAdjTrmDate|FpFraUnAdjDate|FpFraPayDayBusDayConv|FpFraNoOfBusCntr|FpFraFxDatePrdMult|FpFraFxDatePrd|FpFratDtFxDateDayType|FpFraFxDateBusDayConv|FpFraNoOfFxDateBusCntr|FpFraFxDateRltTohref|FpFraDayCountFraction|FpFraCalcPrdNoOfDays|FpFraNotCurrency|FpFraNotAmount|FpFraFxdRate|FpFraFltRateIndex|FpFraIdxTenrPrdMult|FpFraIdxTenrPrd|FpFraDiscounting"> 
  <swap>

    <xsl:call-template name="temp_change_1_1"/>
    <xsl:call-template name="temp_change_1_2"/>
    <xsl:call-template name="temp_change_1_3"/>
    <xsl:call-template name="temp_change_1_4"/>
    <xsl:call-template name="temp_change_1_5"/>
    <xsl:call-template name="temp_change_1_6"/>
    <xsl:call-template name="temp_change_1_7"/>
    <xsl:call-template name="temp_change_1_8"/>
    <xsl:call-template name="temp_change_1_9"/>
    <xsl:call-template name="temp_change_1_10"/>
    <xsl:call-template name="temp_change_1_11"/>
    <xsl:call-template name="temp_change_1_12"/>
    <xsl:call-template name="temp_change_1_13"/>

  </swap>
</xsl:if>
</xsl:template>

<xsl:template name="temp_change_1_1" match="FpFraPayPtyhref"> 
  <buyerPartyReference>
...
<xsl:template name="temp_change_1_2" match="FpFraRcvPtyhref">
...
<xsl:template name="temp_change_1_3" match="FpFraAdjEffDate|FpFraAdjEffDtID">
  <xsl:if test = "FpFraAdjEffDate"> 
...
<xsl:template name="temp_change_1_4" match="FpFraAdjTrmDate">
...
<xsl:template name="temp_change_1_5" match="FpFraUnAdjDate|FpFraPayDayBusDayConv|FpFraNoOfBusCntr">
<xsl:if test = "FpFraUnAdjDate|FpFraPayDayBusDayConv|FpFraNoOfBusCntr"> 
  <paymentDate>

    <xsl:call-template name="temp_change_1_5_1"/>
    <xsl:call-template name="temp_change_1_5_2"/>

  </paymentDate>
</xsl:if>
</xsl:template>

<xsl:template name="temp_change_1_5_1" match="FpFraUnAdjDate">
...
<xsl:template name="temp_change_1_5_2" match="FpFraPayDayBusDayConv|FpFraNoOfBusCntr">
<xsl:if test = "FpFraPayDayBusDayConv|FpFraNoOfBusCntr"> 
  <dateAdjustments>

    <xsl:call-template name="temp_change_1_5_2_1"/>
    <xsl:call-template name="temp_change_1_5_2_2"/>

  </dateAdjustments>
</xsl:if>
</xsl:template>

<xsl:template name="temp_change_1_5_2_1" match="FpFraPayDayBusDayConv">
...
<xsl:template name="temp_change_1_5_2_2" match="FpFraNoOfBusCntr">
  <businessCenters>
     <xsl:for-each select="FpFraNoOfBusCntr/group">

         <xsl:call-template name="temp_change_1_5_2_2_1"/>
 ...
 <xsl:template name="temp_change_1_5_2_2_1" match="FpFraEffBusCntr">
...
<xsl:template name="temp_change_1_6" match="FpFraFxDatePrdMult|FpFraFxDatePrd|FpFratDtFxDateDayType|FpFraFxDateBusDayConv|FpFraNoOfFxDateBusCntr|FpFraFxDateRltTohref">
<xsl:if test = "FpFraFxDatePrdMult|FpFraFxDatePrd|FpFratDtFxDateDayType|FpFraFxDateBusDayConv|FpFraNoOfFxDateBusCntr|FpFraFxDateRltTohref"> 
  <fixingDateOffset>
    ...
    <xsl:call-template name="temp_change_1_6_1"/>
    <xsl:call-template name="temp_change_1_6_2"/>
    <xsl:call-template name="temp_change_1_6_3"/>
    <xsl:call-template name="temp_change_1_6_4"/>
    <xsl:call-template name="temp_change_1_6_5"/>
    <xsl:call-template name="temp_change_1_6_6"/>

  </fixingDateOffset>
</xsl:if>
</xsl:template>

 <xsl:template name="temp_change_1_6_1" match="FpFraFxDatePrdMult">
  ...
  <xsl:template name="temp_change_1_6_2" match="FpFraFxDatePrd">
...
<xsl:template name="temp_change_1_6_3" match="FpFratDtFxDateDayType">
 ...
 <xsl:template name="temp_change_1_6_4" match="FpFraFxDateBusDayConv">
...
<!--businessCenters-->
 ...
 <xsl:template name="temp_change_1_6_5" match="FpFraNoOfFxDateBusCntr">
  <businessCenters>
     <xsl:for-each select="FpFraNoOfFxDateBusCntr/group">

         <xsl:call-template name="temp_change_1_6_5_1"/>
 ...
 <xsl:template name="temp_change_1_6_5_1" match="FpFraFxDateBusCntr">
...
<xsl:template name="temp_change_1_6_6" match="FpFraFxDateRltTohref">
  <dateRelativeTo>
...
<xsl:template name="temp_change_1_7" match="FpFraDayCountFraction">
...
<xsl:template name="temp_change_1_8" match="FpFraCalcPrdNoOfDays">
...
<xsl:template name="temp_change_1_9" match="FpFraNotCurrency|FpFraNotAmount">
<xsl:if test = "FpFraNotCurrency|FpFraNotAmount"> 
  <notional>

    <xsl:call-template name="temp_change_1_9_1"/>
    <xsl:call-template name="temp_change_1_9_2"/>

  </notional>
</xsl:if>
</xsl:template>

<xsl:template name="temp_change_1_9_1" match="FpFraNotCurrency">
...
<xsl:template name="temp_change_1_9_2" match="FpFraNotAmount">
...
<xsl:template name="temp_change_1_10" match="FpFraFxdRate">
...
<xsl:template name="temp_change_1_11" match="FpFraFltRateIndex">
...
<xsl:template name="temp_change_1_12" match="FpFraIdxTenrPrdMult|FpFraIdxTenrPrd">
<xsl:if test = "FpFraIdxTenrPrdMult|FpFraIdxTenrPrd"> 
  <indexTenor>

    <xsl:call-template name="temp_change_1_12_1"/>
    <xsl:call-template name="temp_change_1_12_2"/>

  </indexTenor>
</xsl:if>
</xsl:template>

<xsl:template name="temp_change_1_12_1" match="FpFraIdxTenrPrdMult">
...
<xsl:template name="temp_change_1_12_2" match="FpFraIdxTenrPrd">
...
<xsl:template name="temp_change_1_13" match="FpFraDiscounting">
  ...
  <xsl:template name="temp33" match="RequestLimitCheck"><!-- root template -->
  <requestLimitCheck fpmlVersion="5-6" >
 ...
 <xsl:if test="FpNoOfPartyID/group">
	...
	<xsl:if test="FpPartyIDValue">
      ...
      <account>
                  ...
                  <accountBeneficiary>
                    <xsl:attribute name="href">
                         <xsl:value-of select="FpAccountBenhref"/> 
                      </xsl:attribute>
                  </accountBeneficiary>

                  <servicingParty>
                    <xsl:attribute name="href">
                         <xsl:value-of select="FpAccountSurvPartyhref"/> 
                      </xsl:attribute>
                  </servicingParty>
