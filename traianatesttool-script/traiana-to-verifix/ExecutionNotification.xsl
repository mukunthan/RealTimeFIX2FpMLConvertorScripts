<xsl:stylesheet
 ...
 <xsl:template name="temp2" match="isCorrection">
 ...
 <xsl:variable name="cur" select="count(executionNotification/trade/tradeHeader/partyTradeIdentifier)" />


<xsl:template name="temp5" match="trade/tradeHeader">
	<xsl:if test = "trade/tradeHeader" >
  ...
  <!--  '*/originatingTradeId/tradeId' block  -->
      <xsl:if test = "originatingTradeId/tradeId">

        <FpTrdTrdHdrPtyTrdIdfOrgTrdID>
           <xsl:value-of select="$cur4" />
         </FpTrdTrdHdrPtyTrdIdfOrgTrdID>

         <FpTrdTrdHdrPtyTrdIdfOrgTrdIDSch>
           <xsl:value-of select="originatingTradeId/tradeId/@tradeIdScheme" />
         </FpTrdTrdHdrPtyTrdIdfOrgTrdIDSch>
      ...
      <xsl:if test = "originatingTradeId/partyReference">
          <FpTrdTrdHdrPtyTrdIdfOrgPtyhref>
            <xsl:value-of select="originatingTradeId/partyReference/@href" />
          </FpTrdTrdHdrPtyTrdIdfOrgPtyhref>
      </xsl:if>

  <!-- End '*/originatingTradeId/tradeId' block  -->
...
<xsl:variable name="FpNoOfSwpStrms" select="count(executionNotification/trade/swap/swapStream)" />
...
<!-- paymentDates -->
  ...
  <xsl:variable name="noOfbusinessCenter" select="count(executionNotification/trade/swap/paymentDate/dateAdjustments/businessCenters/businessCenter)" />
  <xsl:variable name="noOfbusinessCenter2" select="count(executionNotification/trade/swap/fixingDateOffset/businessCenters/businessCenter)" />
 ...
 <xsl:variable name="NoOfParty" select="count(executionNotification/party)" />

 <xsl:template name="temp10" match="executionNotification">
